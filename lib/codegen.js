...
var getViewForSwagger2 = function(opts, type) {
    ...
    _.forEach(swagger.paths, function(api, path) {
        ...
        _.forEach(api, function(op, m) {
            ...
            method.isParameters = method.parameters.length > 0;
            if (method.isPATCH && method.parameters.length >= 1) {
                for (var i = 0; i < method.parameters.length; i++) {
                    if (method.parameters[i].isBodyParameter) method.patchbody = method.parameters[i];
                }
            }
